<?php
/*
	Plugin Name: BH Optimize 
	Description: Quick wordpress optimize!
	Author: Birds Host
...
if ( ! class_exists( 'BH_Optimize' ) ) {
	class BH_Optimize {
		protected $tag = 'bh_optimize';
		protected $name = 'BH Optimize';
		protected $version = '1';
		...
		public function add_plugin_page() {
			add_options_page(
				__('BH Optimize Options', 'wp-tuning'),
				__('BH Optimize', 'wp-tuning'), 
		...
		public function create_admin_page() {
			echo '<div class="wrap">';
			echo '<h2>' . __('BH Optimize Options', 'wp-tuning') . '</h2>';
